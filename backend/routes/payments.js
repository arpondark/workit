...
router.post('/pay', protect, authorize('client'), async (req, res) => {
    try {
...
router.post('/withdraw', protect, authorize('freelancer'), async (req, res) => {
    try {
...
// @access  Private (Freelancer)
router.get('/earnings', protect, authorize('freelancer'), async (req, res) => {
    try {
